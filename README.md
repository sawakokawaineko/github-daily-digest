...
https://github.com/sawakokawaineko/github-daily-digest/settings/secrets/actions で以下を登録します。
...
2. https://github.com/sawakokawaineko/github-daily-digest/settings/secrets/actions で `DIGEST_GITHUB_TOKEN` を上書き
